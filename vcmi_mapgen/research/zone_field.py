...
This is research/reporting code: does a real zone's open/blocked web actually reproduce the
corpus's run-length/budget statistics? The production dependency this module used to carry
